from waterflow import pressure_gain_from_water_height, pressure_loss_from_pipe, water_column_height, pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction
from pytest import approx
import pytest


def test_water_column_height():
    """Test the water_column_height function."""
...
def test_pressure_gain_from_water_height():
    """Test the pressure_gain_from_water_height function."""
    assert pressure_gain_from_water_height(0.0) == approx(0.000, abs=0.001)
    assert pressure_gain_from_water_height(30.2) == approx(295.628, abs=0.001)  # 98.1 kPa
    assert pressure_gain_from_water_height(50.0) == approx(489.450, abs=0.001)  # 245.25 kPa

def test_presssure_loss_from_pipe():
    """Test the pressure_loss_from_pipe function."""
    assert pressure_loss_from_pipe(0.048692, 0.00, 0.018, 1.75) == approx(0.0, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 200.00, 0.00, 1.75) == approx(0.00, abs=0.001)
...
def test_pressure_loss_from_fittings():
    """Test the pressure_loss_from_fittings function."""
    assert pressure_loss_from_fittings(0.00, 0) == approx(0.0, abs=0.001)
...
def test_reynolds_number():
    """Test the reynolds_number function."""
    assert reynolds_number(0.048692, 0.00) == approx(0.0, abs=1)
    assert reynolds_number(0.048692, 1.75) == approx(84921, abs=1)
...
def test_pressure_loss_from_pipe_reduction():
    """Test the pressure_loss_from_pipe_reduction function."""
    assert pressure_loss_from_pipe_reduction(0.048692, 0.0, 1, 0.048692) == approx(0.0, abs=0.001)
