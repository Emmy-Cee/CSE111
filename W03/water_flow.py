...
#the program defined constants for the density, dynamic viscosity of water and earth gravity
#the program converts the pressure in psi to Kilopascals and displays both values
...
WATER_DYNAMIC_VISCOSITY = 0.0010016# density of water (998.2 kilogram / meter^3)
