def main():
    ...
    COLOR_INDEX = 3
    YEAR_INDEX = 0
    ENGINE_DESIGN_INDEX = 4
    ENGINE_DISPLACEMENT_INDEX = 5
    ...
    if vin in vehicles_dict:
        ...
        print(f"Manufacturer: {value[MANUFACTURER_INDEX]}")
        print(f"Model: {value[MODEL_INDEX]}")
        print(f"Color: {value[COLOR_INDEX]}")
        print(f"Year: {value[YEAR_INDEX]}")
        print(f"Engine Design: {value[ENGINE_DESIGN_INDEX]}")
        print(f"Engine Displacement: {value[ENGINE_DISPLACEMENT_INDEX]}")
