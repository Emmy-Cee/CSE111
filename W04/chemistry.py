...
def main():
    ...
    from formula import parse_formula  # Make sure formula.py is in the same directory
...
def make_periodic_table():
    """Return a dictionary of the periodic table with symbol as key and [name, atomic_mass] as value."""
    periodic_table_dict = {
        "Ac": ["Actinium", 227],
        "Ag": ["Silver", 107.8682],
