def main():
    # Get a starting odometer value in U.S. miles from the user.
    start_miles = float(input("Enter the starting odometer value in miles: "))
    # Get an ending odometer value in U.S. miles from the user.
    ...
    print(f"Your vehicle's fuel efficiency is {mpg:.2f} miles per gallon.")
...
def miles_per_gallon(start_miles, end_miles, amount_gallons):
    ...
    """
    miles_per_gallon = float(end_miles - start_miles) / float(amount_gallons)
